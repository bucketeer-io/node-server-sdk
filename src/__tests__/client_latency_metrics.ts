...
test('getEvaluation emits latency metrics using injected clock for remote evaluation', async (t) => {
...
test('getEvaluation emits latency metrics using injected clock for local evaluation', async (t) => {
  const sandbox = sinon.createSandbox();
