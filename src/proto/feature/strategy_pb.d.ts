...
export class FixedStrategy extends jspb.Message {
  getVariation(): string;
  setVariation(value: string): FixedStrategy;
...
export class RolloutStrategy extends jspb.Message {
  ...
  setVariationsList(value: Array<RolloutStrategy.Variation>): RolloutStrategy;
...
export namespace RolloutStrategy {
  ...
  export class Variation extends jspb.Message {
    getVariation(): string;
    setVariation(value: string): Variation;
    getWeight(): number;
    setWeight(value: number): Variation;
